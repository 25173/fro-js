...
function instruction9() {
    ...
    btn.setAttribute("id", "btn_links");
    var t = document.createTextNode("Links");
    btn.appendChild(t);

    var btnr = document.createElement("button");
    btnr.setAttribute("id", "btn_recht");
    var t = document.createTextNode("recht");
    btnr.appendChild(t);
    ...
    var description = " voeg element toe : image en button ";

    updateContent("Opdracht 9 - create element",description,"");
    ...
    document.getElementById("instructionResult").appendChild(btnr);

//addEventListener
    document.getElementById("btn_links").addEventListener("click", ()=>{
        alert('naar links');
    });

    document.getElementById("btn_recht").addEventListener("click", ()=>{
        alert('naar rechts');
    });
}

function instruction10() {
    let header = "Opdracht 10- Het object String";
    let description = "string bewerken";
    ...
    updateContent(header,description,result);
...
function instruction11() {
    ...
    let description = "Fout netjes afhandelen.";
